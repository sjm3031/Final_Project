...
<body>
	...
	<table width="1000" align="center">
		<tr>
			...
			[<a href="monthRead.cafe?pg=1">◀◀</a>]
			[<a href="monthRead.cafe?pg=${fromPage-1}">◀</a>]		
			...
			[<span style="color: gray">◀</span>]
					...
					<c:if test="${i!=pg}">
				[<a href="monthRead.cafe?pg=${i}">${i}</a>]
			</c:if>
				</c:forEach> <!-- 다음, 이후 --> <c:if test="${toPage<allPage}">
					<!-- 20<21 : true -->
				[<a href="monthRead.cafe?pg=${toPage+1}">▶</a>]
				[<a href="monthRead.cafe?pg=${allPage}">▶▶</a>]
