      ...
      <div id="content-wrapper" style="padding: 2em;">	
          ...
          <c:forEach var="b" items="${list}">
                      ...
                      <tr>
                        ...
                        <td><input class="btn btn-primary" type="button" value="수정" onclick="location.href='updateform.cafe?customer_code=${b.customer_code}&pg=${pg}'" /></td>
                      </tr>
    ...
    <div class="modal fade" id="addCafeCustomerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <form name = "writeform" class="" action="write.cafe" method="post" onsubmit="return customer_insert();">
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="">고객 전화번호<small class="text-muted"> '-' 없이 잆력해 주세요. EX ) 01012341234</small></label>
                <input type="number" class="form-control" name="customer_phone" value="" placeholder="전화번호를 입력해주세요." required>
              </div>
              
                 <div class="form-group">
                <label for="">고객 생년월일<small class="text-muted"> EX ) 2020.07.27 >> 200727</small></label>
           ...
           <div class="form-group">
		    ...
		    <input type="radio" class="form-control gender" name="customer_gender"  value="f" required/></div>
              ...
              <div class="form-group" >
                ...
                <div class="form-group">
                <label for="">고객 비밀번호 <small class="text-muted">최소 6자리 이상 입력해 주세요.</small></label>
                <input type="text" class="form-control" name="customer_pwd" value="" placeholder="비밀번호를 입력해주세요." required>
              </div>
