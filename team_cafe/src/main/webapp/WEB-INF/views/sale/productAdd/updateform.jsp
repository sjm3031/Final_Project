		...
		<div id="content-wrapper" style="margin: 2em;">
				...
				<div class="modal-content">
					<div class="modal-header bg-secondary text-white">
						<h7 class="modal-title" id="">
							<i class="fa fa-tag"></i> 판매 상품 옵션(추가사항) 수정
						</h7>
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="hidden" name="product_add_code" value="${b.product_add_code}"/>		
			
                <input type="text" class="form-control" name="product_add_name" value="${b.product_add_name}" required>
                <small class="text-muted">정확히 입력해주세요.</small>
              </div>
              <div class="form-group">
                <label for="">옵션(추가사항) 가격 <small class="text-muted">(개당 가격)</small> </label>
                <input type="number" class="form-control" name="product_add_price" value="${b.product_add_price}"  required>
              </div>       
