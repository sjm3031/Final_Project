      ...
      <div id="content-wrapper" style="margin: 2em;">	
          ...
          <c:forEach var="b" items="${list}">
                      ...
                      <tr>
                        ...
                        <td><img src="../../../sale/upload/${b.cafe_product_img}" style="width:150px;"></td>
                        <td>${b.cafe_product_name}</td>
						<td>${b.cafe_product_price}</td>
                        <td><input class="btn btn-primary"  type="button" value="수정" onclick="location.href='updateform.cafe?num=${b.cafe_product_code}&pg=${pg}'" /></td>
                      </tr>
