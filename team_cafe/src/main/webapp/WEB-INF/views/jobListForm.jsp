...
<body>
<form action="jobList.cafe" method="post">
	<table border="1">
		<tr>
		...
		<c:forEach items="${list }" var="list">
			<tr>
				...
				<td>${list.job_mpay }</td>
				<td>
					<input type="button" value="수정" onclick="location.href='jobUpdate.cafe?job_code=${list.job_code}'">
					<input type="button" value="삭제" onclick="location.href='jobDelete.cafe?job_code=${list.job_code}'">
				</td>
			</tr>
		</c:forEach>
	</table>
