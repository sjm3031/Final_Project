          ...
          <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="sales-count.cafe">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="top-selling.cafe">
                  <span class="float-left">세부사항</span>
                  <span class="float-right">
                    <i class="fa fa-angle-right"></i>
                  </span>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
              <div class="card text-white bg-dark o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="short-items.cafe">
                  <span class="float-left">세부사항</span>
                  <span class="float-right">
                    <i class="fa fa-angle-right"></i>
                  </span>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="improvements.cafe">
                  <span class="float-left">세부사항</span>
                  <span class="float-right">
                    <i class="fa fa-angle-right"></i>
                  </span>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-danger" href="login.cafe">로그아웃</a>
          </div>
        </div>
      </div>
    </div>
