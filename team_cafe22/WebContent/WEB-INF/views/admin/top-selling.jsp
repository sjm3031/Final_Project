...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="modal fade" id="addExpenseAccountModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    </div>      <script src="resources/js/jquery.min.js"></script>
      ...
      <script src="resources/js/chart-pie-demo-3months.js"></script>
      <script src="resources/js/chart-pie-demo-6months.js"></script>
    </body>
  </html>
