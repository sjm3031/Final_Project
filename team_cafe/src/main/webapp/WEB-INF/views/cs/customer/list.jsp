...
<!-- #addStockModal -->
   ...
   <div class="modal fade" id="addSalaryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="addCafeCustomerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" onsubmit="return customer_insert()">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title" id="exampleModalLabel">
           ...
           <div class="form-group">
		    ...
		    <input type="radio" class="form-control gender" name="customer_gender"  value="f" required/></div>
              ...
              <div class="form-group" >
                ...
                <input type="password" class="form-control" name="customer_pwd" value="" placeholder="숫자와 문자 포함 형태의 6~12자리 이내로 입력해주세요." required>
              </div>
