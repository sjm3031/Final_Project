      ...
      <div id="content-wrapper" style="padding: 2em;">	
          <div class="container-fluid">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">근태조회</li>
            </ol>
            <!-- Page Content -->
            <!-- DataTables Example -->
            <div class="card mb-3">
		...
		<c:forEach var="list" items="${empTnaList}">
			...
			<tr>
				...
				<td><input type="button" class="btn btn-primary" value="수정" onclick="location.href='update2.cafe?emptna_code=${list.emptna_code}&pg=${pg}'"></td>
		                  ...
		                  <div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate" >
			                  <ul class="pagination" style="text-align: center; width: 350px !important;" >
			                 			 ...
			                 			 <li class="paginate_button page-item " >
								           <a href="monthRead.cafe?pg=1&emptna_year=${emptna_year}&emptna_month=${emptna_month}&employee_name=${employee_name}" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link" >
					             		   	&lt;&lt;
					        	         </a>
			
			                  		<c:if test="${pg>1}">  <!-- 5>10 : false / 15>10 : true -->
										<li class="paginate_button page-item ">
								           <a href="monthRead.cafe?pg=${pg-1}&emptna_year=${emptna_year}&emptna_month=${emptna_month}&employee_name=${employee_name}" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link">
					             		    &lt;
					             		    </a>
					             	    </li>
									</c:if>
					          ...
					          <c:forEach begin="${fromPage}" end="${toPage}" var="i">
					            ...
					            <c:if test="${i!=pg}">
		            				  <li class="paginate_button page-item ">
		            				  	<a href="monthRead.cafe?pg=${i}&emptna_year=${emptna_year}&emptna_month=${emptna_month}&employee_name=${employee_name}" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link">
					             		    ${i}
					        	         </a>
					                 </li>
					    	       </c:if>
					       ...
					       <c:if test="${pg<allPage}"> 
				             ...
				             <c:if test="${pg>=allPage}"> 
				               ...
				               <li class="paginate_button page-item ">
								           <a href="monthRead.cafe?pg=${allPage}&emptna_year=${emptna_year}&emptna_month=${emptna_month}&employee_name=${employee_name}" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link">
					             		    >>
					        	         </a>
					           </li>   
          ...
          <form action="monthRead.cafe" method="post">
            <div class="modal-body">
              <div class="form-group">
                <label>년</label>
                <select name="emptna_year" required>
              ...
              <div class="form-group">
                <label>월</label>
                <select name="emptna_month" required>
			<option value="">선택하세요</option> 
        ...
        <div class="modal-content">
          ...
          <form action="dayRead.cafe" method="post">
			...
			<option value="">선택하세요</option> 
              ...
              <div class="form-group">
                <label for="">일</label>
                <select name="emptna_day" required>
			<option value="">선택하세요</option> 
