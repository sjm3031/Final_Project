      ...
      <div id="content-wrapper" style="padding: 2em;">	
          ...
          <c:forEach var="emp" items="${list}">
                      ...
                      <tr>
                        ...
                        <td><input type="button" value="수정" class="btn btn-primary" onclick="location.href='updateForm.cafe?num=${emp.employee_code}&pg=${pg}'" /></td>
                        <td>
                        <c:if test="${emp.employee_enddate eq null}">
                        	<input type="button" value="퇴사처리" class="btn btn-secondary" onclick="location.href='update2.cafe?employee_code=${emp.employee_code}&pg=${pg}'" /></td>
                      	</c:if>
                      </tr>
