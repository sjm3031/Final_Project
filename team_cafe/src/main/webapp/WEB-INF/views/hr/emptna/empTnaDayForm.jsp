      ...
      <div id="content-wrapper" style="padding: 2em;">	
		...
		<c:forEach var="list" items="${empTnaList}">
			...
			<tr>
				...
				<td><input type="button" value="수정" class="btn btn-primary" onclick="location.href='update2.cafe?emptna_code=${list.emptna_code}&pg=${pg}'"></td>
		                  ...
		                  <div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate" >
			                  <ul class="pagination" style="text-align: center; width: 350px !important;" >
			                 			 ...
			                 			 <li class="paginate_button page-item " >
								           <a href="dayRead.cafe?pg=1&emptna_year=${emptna_year}&emptna_month=${emptna_month}&emptna_day=${emptna_day}" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link" >
					             		   	&lt;&lt;
					        	         </a>
			
			                  		<c:if test="${pg>1}">  <!-- 5>10 : false / 15>10 : true -->
										<li class="paginate_button page-item ">
								           <a href="dayRead.cafe?pg=${pg-1}&emptna_year=${emptna_year}&emptna_month=${emptna_month}&emptna_day=${emptna_day}" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link">
					             		    &lt;
					             		    </a>
					             	    </li>
									</c:if>
					          ...
					          <c:forEach begin="${fromPage}" end="${toPage}" var="i">
					            ...
					            <c:if test="${i!=pg}">
		            				  <li class="paginate_button page-item ">
		            				  	<a href="dayRead.cafe?pg=${i}&emptna_year=${emptna_year}&emptna_month=${emptna_month}&emptna_day=${emptna_day}" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link">
					             		    ${i}
					        	         </a>
					                 </li>
					    	       </c:if>
					       ...
					       <c:if test="${pg<allPage}"> 
				             ...
				             <c:if test="${pg>=allPage}"> 
				               ...
				               <li class="paginate_button page-item ">
								           <a href="dayRead.cafe?pg=${allPage}&emptna_year=${emptna_year}&emptna_month=${emptna_month}&emptna_day=${emptna_day}" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link">
					             		    >>
					        	         </a>
					           </li>   
