...
<body id="page-top">
	...
	<input type="hidden" name="pg" value="${pg}"/>
            <div class="modal-body">
             ...
             <%--    <input type="text" class="form-control" name="customer_phone" value="${b.customer_birth}" required> --%>
                
         <c:if test="${b.customer_gender == null}">
         <div style=" float: left; width: 30%;" class="customGen">
         <label for="" class="label">남
         <input type="radio" class="form-control gender" name="customer_gender" name="gender" value="m" checked/>
         </div>
         </label>
         <div style=" float: left; width: 30%;" class="customGen">
         <label for="" class="label">여
         <input type="radio" class="form-control gender" name="customer_gender" name="gender" value="f" />
         </div>
          </label>
         </c:if>
      ...
      <label for="" class="label">남
       ...
       <c:if test="${b.customer_gender eq 'f'}">
        <div style=" float: left; width: 30%;" class="customGen">
       <label for="" class="label">남
         <input type="radio" class="form-control gender" name="customer_gender" name="gender" value="m" />
         </div>
         </label>
         <div style=" float: left; width: 30%;" class="customGen">
         <label for="" class="label">여
         <input type="radio" class="form-control gender" name="customer_gender" name="gender" value="f" checked/>
         </div>
         </label>
         </c:if>
                <small class="text-muted mes">성별 체크해주세요.</small>
              </div>
              
               <div class="form-group">
                <label for="" class="stamp">고객 스템프 수</label>
                <input type="text" class="form-control" name="customer_stamp" value="${b.customer_stamp}" required>
                <small class="text-muted">정확히 입력해주세요.</small>
              </div>
              
                 <div class="form-group">
                <label for="">고객 비밀번호</label>
                <input type="text" class="form-control" name="customer_pwd" value="${b.customer_pwd}" required>
                <small class="text-muted">정확히 입력해주세요.</small>
              </div>
