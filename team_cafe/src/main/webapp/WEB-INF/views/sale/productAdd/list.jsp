      ...
      <div id="content-wrapper" style="margin: 2em;">	
          <div class="container-fluid">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">상품 옵션(추가 사항) 조회</li>
            </ol>
            <!-- Page Content -->
            <!-- DataTables Example -->
            <div class="card mb-3">
              <div class="card-header bg-primary text-white" style="background-color:#787878  !important;">
               ...
               상품 옵션(추가 사항)
                <a href="#" class="text-white" data-toggle="modal" data-target="#addCafeProductAddModal">
          ...
          <c:forEach var="b" items="${list}">
                      ...
                      <tr>
                       ...
                       <td><input class="btn btn-primary" type="button" value="수정" onclick="location.href='updateform.cafe?num=${b.product_add_code}'" /></td>
                      </tr>
