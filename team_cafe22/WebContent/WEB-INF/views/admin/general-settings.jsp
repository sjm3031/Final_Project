...
<html lang="en">
  <head>
    ...
    <title>RC-POS - General Settings</title>
      ...
      <ul class="navbar-nav ml-auto ml-md-0">
        <li class="nav-item dropdown no-arrow mx-1">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="messagesDropdown">
            ...
            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#addProductVendorModal"> <i class="fa fa-industry"></i> New Product Vendor</a>
            <div class="dropdown-divider"></div>
        ...
        <li class="nav-item dropdown no-arrow mx-1">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="messagesDropdown">
            <a class="dropdown-item" href="products.do"> <i class="fa fa-tag"></i> All Products</a>
            <a class="dropdown-item" href="product-types.do"> <i class="fa fa-tags"></i> Product Types</a>
            <a class="dropdown-item" href="product-vendors.do"> <i class="fa fa-user"></i> Product Vendors</a>
            <a class="dropdown-item" href="product-brands.do"> <i class="fa fa-industry"></i> Product Brands</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="revenue.do"> <i class="fa fa-money"></i> Revenue</a>
            <a class="dropdown-item" href="improvements.do"> <i class="fa fa-rocket"></i> Improvements</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="accounts.do"> <i class="fa fa-dollar"></i> Accounts</a>
          </div>
        </li>
        <li class="nav-item dropdown no-arrow ml-3">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="alertsDropdown">
            ...
            <a class="dropdown-item text-danger no-text-decorations" href="#"> <i class="fa fa-info-circle"></i> Another new notification</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="notifications.do">See more notifications</a>
          </div>
        </li>
        <li class="nav-item dropdown no-arrow ml-3">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            ...
            <a class="dropdown-item" href="profile.do"> <i class="fa fa-user"></i> Profile</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="#"> <i class="fa fa-cog"></i> Settings</a>
            <a class="dropdown-item" href="history.do"> <i class="fa fa-line-chart"></i> Activity Log</a>
            <div class="dropdown-divider"></div>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="products.do"> <i class="fa fa-tags"></i> All Products</a>
            <div class="dropdown-divider"></div>
            ...
            <a class="dropdown-item" href="product-types.do"> <i class="fa fa-tags"></i> Product Types</a>
            <div class="dropdown-divider"></div>
            <h6 class="dropdown-header">Dealers &amp; Vendors</h6>
            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#addProductVendorModal"> <i class="fa fa-user"></i> Add New Vendor</a>
            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#addProductVendorModal"> <i class="fa fa-industry"></i> Add New Vendor</a>
          </div>
        </li>
        <li class="nav-item">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a class="btn btn-danger" href="login.do">Logout</a>
            </div>
          </div>
        </div>
      </div>
