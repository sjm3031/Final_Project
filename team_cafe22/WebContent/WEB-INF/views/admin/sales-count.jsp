  ...
  <head>
   ...
   <body id="page-top">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                <div class="card text-white bg-primary o-hidden h-100">
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-text">
                      <h1 class="text-center display-3"><strong>Null<span class="small" style="font-size: 20px;">k</span></strong></h1>
                    </div>
                  </div>
    ...
    <div class="modal fade" id="addExpenseAccountModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <script src="resources/js/chart-area-demo-6months.js"></script>
    </body>
  </html>
